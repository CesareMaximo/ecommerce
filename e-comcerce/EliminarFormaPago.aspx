<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliminarFormaPago.aspx.cs" Inherits="e_comcerce.EliminarFormaPago" %>
  ...
  <tbody>
    <tr>
      ...
      <td> <%: objFormaPago.Descripcion %></td>
       ...
       <tr>
                <td> <p> ¿Desea Eliminar esta Forma de Pago? </p></td>
