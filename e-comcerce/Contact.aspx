...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-2" >
        ...
        <asp:TextBox ID="txtEmail" CssClass="form-control" TextMode="Email" maxlength="50"  runat="server"></asp:TextBox>
        <div id="emailHelp" class="form-text">.</div>
    </div>
    <div class="mb-3">
        <label for="txtCelular" class="form-label">Celular:</label>

        <asp:TextBox ID="txtCelular" CssClass="form-control" textMode="Number" min="1" runat="server"></asp:TextBox>
    </div>
    <div class="mb-3">
        <label for="txtDescripcion" class="form-label">Descipcion de su problema:</label>

        <asp:TextBox ID="txtDescripcion" CssClass="form-control" maxlength="500"  runat="server"></asp:TextBox>
    </div>
        <hr />
